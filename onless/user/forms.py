...
class EditPupilForm(ModelForm):
    ...
    birthday = forms.CharField(label='Tug\'ilgan vaqti',  required=False, widget=forms.TextInput(attrs={'class': 'form-control', 'type': 'date','id': 'birthday', 'required': False,}))
    ...
    passport_issued_time = forms.CharField(label='Fuqarolik passportining berilgan vaqti',  required=False, widget=forms.TextInput(attrs={'class': 'form-control', 'type': 'date','id': 'passport_issued_time', 'required': False,}))
