...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Birinchi",sLast:"Oxirgi",sNext:"Keyingi",sPrevious:"Oldingi"},sEmptyTable:"Ma'lumot mavjud emas !",sInfo:"Ko'rsatilgan _START_  ta  _END_ dan _TOTAL_",sInfoEmpty:"Ko'rsatilgan 0 to 0 of 0",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
