...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Birinchi",sLast:"Oxirgi",sNext:"Keyingi",sPrevious:"Oldingi"},sEmptyTable:"Ma'lumot mavjud emas !",sInfo:"Ko'rsatilgan _START_  ta  _TOTAL_ dan _END_",sInfoEmpty:"Ko'rsatilgan 0 to 0 of 0",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Ko'rish: _MENU_ ",sLoadingRecords:"Yuklanish...",sProcessing:"Qayta ishlash...",sSearch:"Qidiruv:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Ma'lumot topilmadi !"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
