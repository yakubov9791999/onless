...
function instruction_sweet() {
    var html = `<p>Hurmatli foydalanuvchi ! <a href="onless.uz">Onless.uz</a> tizimidan foydalanish bo'yicha yo'riqnoma bilan tanishib chiqing!</p>
<p style="text-align:left">1.<a href="{% url 'video:categories_list' %}">Videodarslar</a> bo'limidagi barcha videolar to'liq oxirigacha ko'rilishi lozim.</p>
...
<p style="text-align:left">3.<a href="{% url 'quiz:select_lang' %}">Test savollari</a>  bo'limiga o'tib mashg'ulot rejimida har bir biletni yechib chiqish (Eslatma: Agar mavjud biletdagi 10 ta savolga 10 ta javob to'g'ri berilmasa keyingi bilet ochilmaydi)</p>
<p style="text-align:left">4.Mashg'ulot rejimida barcha biletlar ko'rib chiqilgandan so'ng imtihon rejimida o'zingizni sinovdan o'tkazing!</p>
...
<p style="text-align:left">Bizning tizimdan foydalanish uchun sizga yuborilgan login va parolning logini sizning passport seriyangiz, parolni esa tizimning o'zi avtomatik holatda 7 xonali sondan iborat raqam generatsiya qilib qo'yadi. Agarda siz o'zingiz uchun esda qolarli parol yaratmoqchi bo'lsangiz. Menyuga kirib tahrirlash bo'limidan parolni o'zgartiring va saqlashga bosing.</p>`
